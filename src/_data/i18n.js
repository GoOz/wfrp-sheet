export default {
  ...
  points: {
    ...
    resolve: {
      ...
      availablePoints: {
        ...
        es: "Puntos de Determinación disponibles",
      },
      totalPoints: {
        ...
        es: "Puntos de Determinación totales",
      },
    },
    motivation: {
      title: {
  ...
  wounds: {
    ...
    willPowerBonus: {
      ...
      es: "Bonificador de Fuerza de Voluntad",
    },
    willPowerBonusAbbr: {
      fr: "BFM",
      en: "WPB",
    ...
    hardyLabel: {
      ...
      es: "Nivel del Talento Duro de Roer",
    },
    current: {
